 ...
 <title>App Downloading</title>
  ...
  <table width="871" border=5 align="center" class="a">
    ...
    <td height="70" colspan=10 align="center">
        <h1>Delete Inserted Aaps For Music </h1></td>
  </tr>
  <hr>
  
  <tr ><td width="85" height="33" align="center">Music Sno</td> 
  <td width="240" align="center">Music Photo</td>
...
Class.forName("com.mysql.jdbc.Driver");
 con=DriverManager.getConnection("jdbc:mysql://localhost:3306/playstoredatabase","root","");
	...
	Statement stmt=con.createStatement();
                ...
                String strQuery = "select M_id,M_name,M_pic from music";
...
<img src="image_2.jsp?imgid=<%=rs.getInt(1)%>"
 ...
 <td align="center" width="197" headers="50"><form action="Delete_2_1.jsp">
