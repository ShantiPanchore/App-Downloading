    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <center><h2 class="title">Admin Login</h2></center><br><br><br>
                    <form  action="LoginCode_1.jsp" method="post" enctype="multipart/form-data" name="form1" onsubmit="return basic()">
                        ...
                        <div class="p-t-10">
                           <a href="Email.jsp" class="input--style-3">Email Send In User</a>
                        </div><br><br>
