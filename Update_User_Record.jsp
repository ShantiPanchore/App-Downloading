<%-- 
    Document   : Update_User_Record
    Created on : Sep 27, 2019, 5:35:14 PM
    Author     : admin
--%>
...
<img src="image.jsp?imgid=<%=rs.getInt(1)%>"
 ...
 <td align="center" width="197" headers="50"><form action="Delete_1.jsp"><input type="submit" value="Update"  font-weight: bold; color: #ffffff;"  onclick="editRecord(<%=rs.getInt(1)%>)"></form></td>
